...
const Nav: React.FC<navInterface> = ({currentSection, homeRef, aboutRef, techRef, projectsRef, contactRef}) => {
  ...
  return (
    <header className='fixed px-[10%] py-[20px] flex justify-between items-center w-[100%] z-10 opacity-90'>
      ...
      <nav>
        ...
        <div className={'animate-slide-top opacity-0 inline-block text-[18px] duration-300 no-underline cursor-pointer font-medium ml-[35px] hover:text-[#0ef] animation-delay-600 ' + isCurrentSection('tech')} onClick={() => executeScroll(techRef)}>Technologie</div>
